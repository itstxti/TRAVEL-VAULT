      ...
      <article className="legal-content">
        ...
        <section>
          ...
          <p>
            ...
            destinations, trips, journal entries and photos. It is operated as
            a personal, non-commercial project by {OPERATOR.name}
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Email and password.</strong> We receive your email
              address and an account identifier. Your password is handled and
              stored by our authentication provider (Supabase) in hashed form;
              it is never visible to the operator of Travel Vault.
            </li>

            <li>
              <strong>Sign in with Google.</strong> We receive the basic
              profile information your Google account releases, which typically
              includes your email address, name, profile picture and an account
              identifier.
            </li>
          </ul>

          <p>
            If you use the password reset feature, your email address is used
          ...
          <p>
            ...
            and end dates, the names of travel companions, dated journal
            entries and photos with their captions.
          </p>
        ...
        <section>
          ...
          <p>
            Travel Vault keeps two copies of your data, and you should know
            about both:
          </p>
          ...
          <p>
            ...
            not currently erase the local copy from that browser. On a shared
            or public computer, clear the site's browsing data afterwards if
            you want the local copy removed.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            disclosed to anyone except the infrastructure providers in section
            5 acting on our behalf, or where disclosure is legally required.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            file itself from storage, not just the database record. In practice
            this means deleted content is gone from our servers within{' '}
            {PURGE_GRACE_PERIOD_DAYS} days at the latest, and often sooner.
          </p>
          ...
          <p>
            ...
            and it will be handled within one month, as required by GDPR Art.
            12(3).
          </p>
        ...
        <section>
          ...
          <p>
            Connections are encrypted in transit, the application sets a
            strict Content Security Policy and related security headers, and
            database access rules restrict each account to its own rows.
            Passwords are stored hashed by the authentication provider.
          </p>
        ...
        <section>
          ...
          <p>
            ...
            delete it, restrict or object to its processing, and receive it in
            a portable format. Most content can be viewed and corrected
            directly in the app; for access copies, portability, or erasure,
            email{' '}
            <a href={`mailto:${OPERATOR.email}`}>
              {OPERATOR.email}
            </a>
            . There is no automated export feature in the app at present, so
            portability requests are handled manually.
          </p>
        ...
        <section>
          ...
          <p>
            ...
            {MINIMUM_AGE} years old to create an account. If you believe a
            child has created an account, contact{' '}
            <a href={`mailto:${OPERATOR.email}`}>
              {OPERATOR.email}
            </a>{' '}
        ...
        <section>
          ...
          <p>
            This policy may be updated. The updated version is published on
            this page with a new date at the top. If a change materially affects
            how your data is handled, you will be notified by email before it
            takes effect.
          </p>
        </section>
